/* autogenerated by Processing revision 1293 on 2023-11-11 */
...
public class Slotting extends PApplet {
...
class Slot {
  ...
  public void drawNumber(int pos) {
    int r = 50;
    int d = 36;
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Slotting" };
    if (passedArgs != null) {
